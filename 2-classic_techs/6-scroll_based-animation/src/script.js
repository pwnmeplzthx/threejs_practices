...
for(let i=0; i < particlesCount; i++) {
    ...
    positions[i*3+1] = parameters.objectsDistance * 0.4 -  Math.random() * parameters.objectsDistance * sectionMeshes.length
...
const tick = () =>
{
    ...
    const paralsxY = - cursor.y * 0.5
    cameraGroup.position.x += (paralaxX - cameraGroup.position.x) * 2 * deltaTime
    cameraGroup.position.y += (paralsxY - cameraGroup.position.y) * 2 * deltaTime
